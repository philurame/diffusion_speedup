...
from datasets.r_coco import COCO_SHORT, COCO_LONG
...
def main(config, device):
    ...
    coco = COCO_SHORT()
    train_dataloader = DataLoader(coco.prompts[:args.max_samples], batch_size=args.train_batch_size, shuffle=False) # ПОПРАВИТЬ
