  ...
  def _call_impl(
    ...
    **kwargs
    ...
    for t in self.scheduler.timesteps:
      image = self.make_unet_solver_step(self.scheduler, image, t, device)
      ...
      ROOT = os.path.dirname(
        os.path.dirname( # lib
          os.path.dirname( # models
            os.path.dirname(os.path.abspath(__file__)) # edm
          )
        )
      )
      local_path = os.path.join(ROOT, 'DATA', "edm-cifar10-32x32-uncond-vp.pkl")
